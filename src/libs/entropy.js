 ...
 * card [A2-9TJQK][CDHS]
 *
 * Automatically uses lowest entropy to avoid issues such as interpreting 0101
...
window.Entropy = new (function () {
  ...
  function getBase(str, baseStr) {
    ...
    if (
      ...
      var ints = binaryMatches.map(function (i) {
        return parseInt(i, 2);
      });
      return {
        ints: ints,
    ...
    if (
      ...
      var ints = diceMatches.map(function (i) {
        return parseInt(i);
      });
      return {
        ints: ints,
    ...
    if (
      ...
      var ints = base6Matches.map(function (i) {
        return parseInt(i);
      });
      return {
        ints: ints,
    ...
    if (
      ...
      var ints = base10Matches.map(function (i) {
        return parseInt(i);
      });
      return {
        ints: ints,
    ...
    var ints = hexMatches.map(function (i) {
