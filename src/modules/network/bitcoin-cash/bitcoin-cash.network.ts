...
//     this.cashAddrAddress = new CashAddrAddress(config[purpose].cashAddr.prefixConfig, mnemonic);
//     this.p2pkhAddress = new P2pkhAddress(config[purpose].legacy.prefixConfig, mnemonic);
//   }
